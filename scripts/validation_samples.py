...
def read_dataframe_for_validation(path):
    return pd.read_csv(path, sep="\t",
                       dtype={
                           "publication_year": str, "latitude": str, "longitude": str, "depth": str, "temp": str, 
                           "pH": str, "salinity": str, "API": str, "NO3-": str, "PO43-": str, "SO42-": str, "Ca2+": str, 
                           "Mg2+": str, "Na+": str, "K+": str, "Cl-": str, "HCO3-": str, "acetate": str, "collection_date": str
                       },
